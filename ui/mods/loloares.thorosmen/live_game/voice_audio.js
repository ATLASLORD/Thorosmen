try
{
    function audioModdingTest()
    {
      ...
      api.audio.registerCueMod('/VO/Computer/gw/intro', dir + 'enemy_elysium_detected.ogg')
      ...
      api.audio.registerCueMod('/VO/Computer/gw/board_tech_available_advanced', dir + 'enemy_elysium_destroyed.ogg')
