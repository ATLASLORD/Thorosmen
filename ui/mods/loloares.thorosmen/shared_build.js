var newBuild = {
    ...
    "/pa/units/thorosmen/atat/atat.json": ["Asemititan", 0, { row: 1, column: 3 }],
    "/pa/units/thorosmen/air_healer/air_healer.json": ["Asemititan", 0, { row: 2, column: 3 }],

    //thorosmen structures
    "/pa/units/thorosmen/canhao/canhao.json": ["structure", 0, { row: 2, column: 0 }],
    "/pa/units/thorosmen/kinha/kinha.json": ["structure", 0, { row: 1, column: 0 }],
    "/pa/units/thorosmen/metal_destructor/metal_destructor.json": ["structure", 0, { row: 1, column: 2 }],
    "/pa/units/thorosmen/titan_radar/titan_radar.json": ["structure", 0, { row: 0, column: 2 }],
    "/pa/units/thorosmen/spell_heal/spell_heal.json": ["structure", 0, { row: 0, column: 1 }],
    "/pa/units/thorosmen/bunker_build/bunker_build.json": ["structure", 0, { row: 0, column: 0 }],
